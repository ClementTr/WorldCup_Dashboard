...
function draw_pitch(){
  ...
  svg_pitch.append("svg:image")
       .attr("xlink:href", "./js/plots/pitch.svg")
       .attr('height', innerH)
       .attr('width', innerW);
  ...
  svg_pitch.append("image")
        ...
        .attr("xlink:href", "./img/players/" + keeper_country + "/" + keeper_name + ".jpg")
  ...
  svg_pitch.append("image")
        ...
        .attr("height", footballer_img_size)
        .attr("width", footballer_img_size)
        .attr("xlink:href", "./img/players/" + defenders_country[0] + "/" + defenders_name[0] + ".jpg")
  ...
  svg_pitch.append("image")
          ...
          .attr("height", footballer_img_size)
          .attr("width", footballer_img_size)
          .attr("xlink:href", "./img/players/" + defenders_country[1] + "/" + defenders_name[1] + ".jpg")
  ...
  svg_pitch.append("image")
          ...
          .attr("height", footballer_img_size)
          .attr("width", footballer_img_size)
          .attr("xlink:href", "./img/players/" + defenders_country[2] + "/" + defenders_name[2] + ".jpg")
  ...
  svg_pitch.append("image")
           ...
           .attr("height", footballer_img_size)
           .attr("width", footballer_img_size)
           .attr("xlink:href", "./img/players/" + defenders_country[3] + "/" + defenders_name[3] + ".jpg")
  ...
  svg_pitch.append("image")
          ...
          .attr("height", footballer_img_size)
          .attr("width", footballer_img_size)
          .attr("xlink:href", "./img/players/" + midfielders_country[0] + "/" + midfielders_name[0] + ".jpg")
  ...
  svg_pitch.append("image")
           ...
           .attr("height", footballer_img_size)
           .attr("width", footballer_img_size)
           .attr("xlink:href", "./img/players/" + midfielders_country[1] + "/" + midfielders_name[1] + ".jpg")
  ...
  svg_pitch.append("image")
          ...
          .attr("height", footballer_img_size)
          .attr("width", footballer_img_size)
          .attr("xlink:href", "./img/players/" + midfielders_country[2] + "/" + midfielders_name[2] + ".jpg")
  ...
  svg_pitch.append("image")
           ...
           .attr("height", footballer_img_size)
           .attr("width", footballer_img_size)
           .attr("xlink:href", "./img/players/" + attackers_country[0] + "/" + attackers_name[0] + ".jpg")
  ...
  svg_pitch.append("image")
          ...
          .attr("height", footballer_img_size)
          .attr("width", footballer_img_size)
          .attr("xlink:href", "./img/players/" + attackers_country[1] + "/" + attackers_name[1] + ".jpg")
  ...
  svg_pitch.append("image")
           ...
           .attr("height", footballer_img_size)
           .attr("width", footballer_img_size)
           .attr("xlink:href", "./img/players/" + attackers_country[2] + "/" + attackers_name[2] + ".jpg")
       ...
       function mousemove_pitch(country, name, x, y) {
          div_popup.transition()
                   ...
                   .style("height", "50px")
                   .style("opacity", .9);
          div_popup.html(name.charAt(0).toUpperCase() + name.slice(1) + " " + "<img src='./img/flags/"+country+".png' style='height:15px'/>")
                   .style("left", x + "px")
                   .style("top", y + "px");
