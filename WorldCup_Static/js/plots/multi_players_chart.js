...
function draw_players(data, innerW, innerH) {
    ...
    svg_players.append("path")
     ...
     svg_players.append("circle")
      ...
      svg_players.append("image")
               ...
               .attr("height", 56)
               .attr("width", 56)
               .attr("xlink:href", "./img/players/" + Country_1 + "/" + Name_1 + ".jpg")
     ...
     svg_players.append("circle")
      ...
      svg_players.append("image")
               ...
               .attr("height", 56)
               .attr("width", 56)
               .attr("xlink:href", "./img/players/" + Country_2 + "/" + Name_2 + ".jpg")
     ...
     svg_players.append("circle")
      ...
      svg_players.append("image")
               ...
               .attr("height", 56)
               .attr("width", 56)
               .attr("xlink:href", "./img/players/" + Country_3 + "/" + Name_3 + ".jpg")
     ...
     svg_players.append("circle")
      ...
      svg_players.append("image")
               ...
               .attr("height", 56)
               .attr("width", 56)
               .attr("xlink:href", "./img/players/" + Country_4 + "/" + Name_4 + ".jpg")
    ...
    svg_players.append("circle")
     ...
     svg_players.append("image")
              ...
              .attr("height", 56)
              .attr("width", 56)
              .attr("xlink:href", "./img/players/" + Country_5 + "/" + Name_5 + ".jpg")
      ...
      function mousemove_1(country, name, x, y) {
        d3v4.select("#player1").attr("class", "hover-line")

        d3v4.select("#player2").style("opacity", "0.1")
        d3v4.select("#player3").style("opacity", "0.1")
        d3v4.select("#player4").style("opacity", "0.1")
        d3v4.select("#player5").style("opacity", "0.1")

        d3v4.select("#circle2").attr("cx", 2000)
        d3v4.select("#img-player2").attr("x", 2000)
        d3v4.select("#circle3").attr("cx", 2000)
        d3v4.select("#img-player3").attr("x", 2000)
        d3v4.select("#circle4").attr("cx", 2000)
        d3v4.select("#img-player4").attr("x", 2000)
        d3v4.select("#circle5").attr("cx", 2000)
        d3v4.select("#img-player5").attr("x", 2000)
        ...
        div_ts_popup.transition()
                 ...
                 .style("height", "50px")
                 .style("opacity", .9);
        div_ts_popup.html(name + "<br><center><img src='./img/flags/"+country+".png' style='height:15px'/></center>")
                 .style("left", x-50 + "px")
                 .style("top", y+20 + "px");
      }
      function mouseout_1(){
        d3v4.select("#player1").attr("class", "line")

        d3v4.select("#player2").style("opacity", "1")
        d3v4.select("#player3").style("opacity", "1")
        d3v4.select("#player4").style("opacity", "1")
        d3v4.select("#player5").style("opacity", "1")

        d3v4.select("#circle2").attr("cx", x_circle_player)
        d3v4.select("#img-player2").attr("x", x_image_player)
        d3v4.select("#circle3").attr("cx", x_circle_player)
        d3v4.select("#img-player3").attr("x", x_image_player)
        d3v4.select("#circle4").attr("cx", x_circle_player)
        d3v4.select("#img-player4").attr("x", x_image_player)
        d3v4.select("#circle5").attr("cx", x_circle_player)
        d3v4.select("#img-player5").attr("x", x_image_player)
      ...
      function mousemove_2(country, name, x, y) {
        d3v4.select("#player2").attr("class", "hover-line")

        d3v4.select("#player1").style("opacity", "0.1")
        d3v4.select("#player3").style("opacity", "0.1")
        d3v4.select("#player4").style("opacity", "0.1")
        d3v4.select("#player5").style("opacity", "0.1")

        d3v4.select("#circle1").attr("cx", 2000)
        d3v4.select("#img-player1").attr("x", 2000)
        d3v4.select("#circle3").attr("cx", 2000)
        d3v4.select("#img-player3").attr("x", 2000)
        d3v4.select("#circle4").attr("cx", 2000)
        d3v4.select("#img-player4").attr("x", 2000)
      ...
      function mouseout_2(){
        d3v4.select("#player2").attr("class", "line")

        d3v4.select("#player1").style("opacity", "1")
        d3v4.select("#player3").style("opacity", "1")
        d3v4.select("#player4").style("opacity", "1")
        d3v4.select("#player5").style("opacity", "1")

        d3v4.select("#circle1").attr("cx", x_circle_player)
        d3v4.select("#img-player1").attr("x", x_image_player)
        d3v4.select("#circle3").attr("cx", x_circle_player)
        d3v4.select("#img-player3").attr("x", x_image_player)
        d3v4.select("#circle4").attr("cx", x_circle_player)
        d3v4.select("#img-player4").attr("x", x_image_player)
      ...
      function mousemove_3(country, name, x, y) {
        d3v4.select("#player3").attr("class", "hover-line")
      ...
      function mouseout_3(){
        d3v4.select("#player3").attr("class", "line")
      ...
      function mousemove_4(country, name, x, y) {
        d3v4.select("#player4").attr("class", "hover-line")
      ...
      function mouseout_4(){
        d3v4.select("#player4").attr("class", "line")
      ...
      function mousemove_5(country, name, x, y) {
        d3v4.select("#player5").attr("class", "hover-line")
      ...
      function mouseout_5(){
        d3v4.select("#player5").attr("class", "line")
