...
urlpatterns = [
    ...
    path('serbra/', views.serbra, name='match'),
    path('denfra/', views.denfra, name='match'),
    path('ururus/', views.ururus, name='match'),
    path('polcol/', views.polcol, name='match'),
    path('gerswe/', views.gerswe, name='match'),
    path('bracrc/', views.bracrc, name='match'),
    path('fraper/', views.fraper, name='match'),
    path('uruksa/', views.uruksa, name='match'),
    path('polsen/', views.polsen, name='match'),
    path('tuneng/', views.tuneng, name='match'),
